---
summary: Compose modern_di.integrations (bind for the TaskiqMessage scope/context derivation, Container's async-with, Marker for the Dependency/FromDI resolution seam) instead of hand-rolling them; no public-API change.
---
